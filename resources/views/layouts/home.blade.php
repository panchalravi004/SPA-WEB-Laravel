    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SPA Admin</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseStudent" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Placed Student</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFaculty" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Faculty Management :</h6>
                        <a class="collapse-item" href="{{ route('view_add_page_faculty') }}">Add Faculty</a>
                        <a class="collapse-item" href="{{ route('view_faculty') }}">View Faculty</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCompany" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('view_add_page_company') }}">Add Company</a>
                        <a class="collapse-item" href="{{ route('view_company') }}">View Company</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseJobs" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('view_add_page_jobs') }}">Add Jobs</a>
                        <a class="collapse-item" href="{{ route('view_jobs') }}">View Jobs</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - University Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseUniversity" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">University Management:</h6>
                        <a class="collapse-item" href="{{ route ('view_university')}}">Manage University</a>
                        <a class="collapse-item" href="{{ route ('view_college')}}">Manage College</a>
                        <a class="collapse-item" href="{{ route ('view_department')}}">Manage Department</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Ravi Panchal</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SPA 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
